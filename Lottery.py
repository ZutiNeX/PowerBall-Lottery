'''
PowerBall Lottery By ZutiNeX
A simulation of the lottery so you can experience the thrill of
losing the lottery without wasting the money
...
while(True):
    ...
    except ValueError("Please enter numbers like 27, 35 or 62"):
        continue
...
while(True):
    print('How many times you want to play(Max:1000000))')
    response = input('> ')
    ...
    try:
        ...
        print("Please enter a number like 3, 15 and  22000.")
        continue
...
for i in range(numPlays):
    ...
    if set(numbers) == set(winningNumbers) and powerball == winningPowerball:
        print()
        print('You have won the powerball lottery, Congragulations')
